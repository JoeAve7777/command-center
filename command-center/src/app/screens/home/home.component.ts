...
export class HomeComponent implements OnDestroy, OnInit {
    ...
    subscribeToEvents() {
        this.dashboardCardExpandRequestedSubscription =
            this.dashboardCardItemService.subscribeToDashboardCardExpandRequestedEvent(
                this,
                (self: HomeComponent, dashboardCardItem: DashboardCardItem) => {
